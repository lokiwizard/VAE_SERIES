...
if __name__ == "__main__":
    ...
    encoder = ViTEncoder(image_size=224, patch_size=16, dim=512, depth=6, heads=8, mlp_dim=2048)
    z = encoder(x)

    decoder = ViTDecoder(image_size=224, patch_size=16, dim=512, depth=6, heads=8, mlp_dim=2048)
    x_recon = decoder(z)
    print(x_recon.shape)  # torch.Size([1, 3, 224, 224])

    print(decoder.get_last_layer().shape)