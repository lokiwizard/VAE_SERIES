...
if __name__ == "__main__":
    ...
    quantization = VectorQuantizer(128, 512, num_quantizers=4, use_residual=True)
    x = torch.randn(1, 196, 128)
    z_q, loss, encoding_indices = quantization(x)
    print(z_q.shape, loss, encoding_indices.shape)  # torch.Size([1, 196, 512]) tensor(0.0002) torch.Size([1, 196])